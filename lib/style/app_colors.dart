...
class AppColors {
  ...
  static const Color secondary = Color(
      0xFF5E5CE5); // Une couleur secondaire (non visible mais bon à avoir)
  static const Color postit =
      Color(0xFFFFF59D); // Couleur d'accentuation (jaune vif)

  // Couleurs de fond
  static const Color background = Color(
      0xFFF6C61E); // Blanc cassé : FAFAF8 ou Beige sable très clair : F7F3E9
  static const Color sheetBackground =
      Color(0xFFF0F0F0); // Gris très clair pour les cartes
